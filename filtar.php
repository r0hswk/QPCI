...
include_once('resources/functions/blog.php');
$app = new Image;
...
global $conn;
    ...
    $query = "SELECT
              ...
              `title`,
               `contents`,
               `images`,`price`,`date_posted`, `cat_id`
               FROM `posts` " ;
    // if(isset($id)){
    //     $id = (int)$id;
      ...
      ?>
        ...
        <div style="padding: 10px;" class="col-lg-3 col-md-6">
          <div class="card custom-card" style="border-radius: 10%;">
            ...
            <div style="height: 150px;text-align: center;width: 100%;"> <img src="<?php echo "./css/img/".$post['images']; ?>" style="border-radius: 10%;padding: 10px;width: 200px;
  height: 150px;width: 100%;;" class="card-img-top" height: 100%;
              width: 100%; alt="Card Image"></div>
            <div class="card-body" style="    height: 200px;">
              <h5 class="card-title" align="right" ><?php echo $post['title']; ?> </h5>
              <br>
              <h7 class="card-title" align="right" ><?php echo $post['price']."$"; ?> </h5>
              <br>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12" id="map" style=" background-color: #333;">
          <h3>ناونیشان</h3>
          <!-- <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3220.058614478863!2d45.10927960000001!3d36.189456299999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4001433ccbe3336d%3A0x6b1486ab106a9cfd!2z2LTZiNuO2YbbjCDYtdmF2K8!5e0!3m2!1sen!2sus!4v1697848046548!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> -->
          <iframe
